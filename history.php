...
?>
<?php $re22 = '/&#9989;/m';/*tick marked*/ $re33 = '/&#10062;/m';/* not tick marked */ $counting22 = preg_match_all($re22, $history, $matches22); $counting33 = preg_match_all($re33, $history, $matches33); echo "<br><b>Total<i>".$counting22." </i>words learnt. <br> Remaining words to learn = <i>".$counting33." </i><br></b>"; ?>
<a class=pup href="#top" id="hulk">Click to go to Top</a><br><br>
